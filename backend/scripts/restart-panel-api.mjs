...
await run("verify", "test -f /home/vpnadm/vpn-admin-app/backend/dist/routes/mySub.js && ! grep -q web_app_new_design /home/vpnadm/vpn-admin-app/backend/dist/routes/mySub.js && echo backend_ok || (echo backend_stale; exit 1)");
